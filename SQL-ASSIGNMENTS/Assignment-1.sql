...
--5.Find position of 'a' in 'Amitabh'
SELECT CHARINDEX('a','Amitabh');

--6.Remove right side spaces from FIRST_NAME
SELECT RTRIM(FIRST_NAME)
FROM Worker;

--7.Remove left side spaces from DEPARTMENT
SELECT LTRIM(DEPARTMENT)
FROM Worker;

--8.Unique DEPARTMENT with its length
...
--13.Workers with FIRST_NAME Vipul and Satish
SELECT *
FROM Worker
...
--15.Workers in Admin department
SELECT *
FROM Worker
...
--18.FIRST_NAME ends with 'h' and six letters
SELECT *
FROM Worker
...
--22.Number of workers in each department
SELECT DEPARTMENT, COUNT(*) AS TOTAL_WORKERS
FROM Worker
GROUP BY DEPARTMENT
ORDER BY TOTAL_WORKERS DESC;

--23.Workers who are also managers
SELECT W.*
FROM Worker W
JOIN Title T
